...
csv_file_path = '/Users/apple/python1/new/Certificate  (Responses) - prompt.csv'
...
certificate_templates = {
    'Prompt': '/Users/apple/python1/certificates/promptgenration_certificate.png',
}
...
def generate_certificate(name, event, event_id):
    ...
    # Updated text positions for readability and customization
    name_x_position = 3700  
    name_y_position = 2850  
    id_x_position = 6000 
    id_y_position = 4000

    # Text color and font settings
    draw.text((name_x_position, name_y_position), name, fill=(22, 54, 73), font=font)
    draw.text((id_x_position, id_y_position), f"ID: {event_id}", fill=(22, 54, 73), font=font1)
...
def send_email(recipient_email, certificate_bytes, event, recipient_name):
    def send_email_thread():
        try:
            ...
            body = f"""Dear {name},
We are thrilled to announce that your certificate for participating in {event} Genration Competition is now available!
