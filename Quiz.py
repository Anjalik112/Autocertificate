...
csv_file_path = '/Users/apple/python1/new/Certificate  (Responses) - Quiz.csv'
...
def generate_certificate(name, event, event_id):
    ...
    name_x_position = 3530  
    name_y_position = 2690  
    id_x_position = 6000 
    id_y_position = 3858  

    # Text color and font settings
    draw.text((name_x_position, name_y_position), name, fill=(51, 39, 21), font=font)
    draw.text((id_x_position, id_y_position), f"ID: {event_id}", fill=(51, 39, 21), font=font1)
