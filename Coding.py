...
csv_file_path = '/Users/apple/python1/csv/Data_EventZen2.0 - Coding.csv'
...
certificate_templates = {
    'Coding': '/Users/apple/python1/certificates/Coding_certificate.png',
}
...
def generate_certificate(name, event, event_id):
    ...
    image.save(img_byte_arr, format='PNG')  # Changed to PNG for better quality
